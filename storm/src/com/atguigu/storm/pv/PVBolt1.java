...
public class PVBolt1 implements IRichBolt {
	...
	public void execute(Tuple input) {
		// 获取传递过来的数据 www.atguigu.com	BBYH61456FGHHJ7JL89RG5VV9UYU7	2017-08-07 10:40:49
...
//		long id = Thread.currentThread().getId();
		...
		System.err.println("threadid:" + Thread.currentThread().getId() + "  session_id"+session_id+"  pv:" + pv);
	}
	
	@Override
	public void declareOutputFields(OutputFieldsDeclarer declarer) {
		//给collector.emit(new Values(Thread.currentThread().getId(), pv));发送的字段起别名
